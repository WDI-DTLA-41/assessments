...
Create a variable in the global scope called name, then write a function called thisName, and create another variable inside the function called name, and console.log name. What do you think the output would be when you invoke the function thisName?
